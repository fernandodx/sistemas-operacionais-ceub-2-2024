...
//O listener é um padrão de design amplamente utilizado no desenvolvimento mobile e em outras áreas 
//da programação. Ele segue o padrão Observer, onde um objeto (o listener) "ouve" eventos de outro objeto
 //(o emitente). Esse padrão é comum em interfaces gráficas e sistemas de eventos.
